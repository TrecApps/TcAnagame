...
TDialog::TDialog(TrecPointer<TWindow> parent, GLFWwindow* win, VkPhysicalDevice anagameVulkanDevice, VkInstance instance)
	: TWindow(win, anagameVulkanDevice, instance)
{
	this->parent = parent;
